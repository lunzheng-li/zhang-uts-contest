...
class Constants(BaseConstants):
    ...
    instructions_template = 'pooled_homo/Instructions_temp.html'
...
class Subsession(BaseSubsession):
    ...
    def creating_session(self):
        # # making num_rounds in config:
        # # do it when necessary, lots of things need to change, let me do it when
        # # have time
        # for p in subsession.get_players():
        #     p.participant.num_rounds = self.session.config['real_periods'] + \
        #         Constants.num_trial_rounds
        ...
        # # the following changes the type across stage
        # self.group_randomly()

        # for group in self.get_groups():
        #     typos_copy1 = Constants.typos.copy()
        #     typos_copy2 = Constants.typos.copy()
        #     random.shuffle(typos_copy1)
        #     random.shuffle(typos_copy2)
        #     print(typos_copy1)
        #     for player in group.get_players():
        #         print(typos_copy1)
        #         player.typo1 = typos_copy1[0]
        #         player.typo2 = typos_copy2[0]
        #         del typos_copy1[0]
        #         del typos_copy2[0]
        ...
        #         # print(player.id_in_group, player.typo1, player.tpp1)
        #         # print(player.id_in_group, player.typo2, player.tpp2)
    ...
    def get_quiz_data(self):
        ...
        return [
            dict(
                name='a',
                solution=4,
                explanation="Your answer is wrong. There are 4 participants in your group.",
            ),
            dict(
                name='b',
                solution=tpp_A,
                explanation="Your answer is wrong. You receive " + str(tpp_A) +" lottery tickets per point spent.",
            ),
            dict(
                name='c',
                solution=100,
...
class Player(BasePlayer):
    ...
    a = models.IntegerField(
        label='1. How many people are in your group?')
    b = models.IntegerField(
        label="2. How many lottery tickets do you receive per point spent?")
