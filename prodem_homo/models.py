...
class Constants(BaseConstants):
    ...
    instructions_template = 'prodem_homo/Instructions_temp.html'
    ...
    def get_quiz_data(self):
        ...
        return [
            ...
            dict(
                name='b',
                solution=tpp_B,
                explanation="Your answer is wrong. Each participant receives " +
...
class Player(BasePlayer):
    ...
    b = models.IntegerField(
        label="1. How many lottery tickets does each participant receive per point spent?")
    c = models.IntegerField(
        label="2. How many points is the reward worth in the Blue division?")
    d = models.IntegerField(
        label="3. How many points is the reward worth in the Red division?")
    e = models.IntegerField(
        label='''4. Suppose you purchase 10 lottery tickets and the other
    ...
    f = models.IntegerField(
        label='''5. Suppose you purchase 60 lottery tickets and the other
        participant in your division purchases 40 lottery tickets.
        What is your probability of receiving the reward in percentage terms?
        (Please refer to formula 4)''')
    g = models.IntegerField(
        label='''6. Suppose you were in the Blue division and you spent 10 points 
    ...
    i = models.IntegerField(
        ...
        label='''8. Suppose you were in the Blue division in stage 1 and you didn't receive
    ...
    j = models.IntegerField(
        ...
        label='''9. Suppose you were in the Red division in stage 1 and you did receive
